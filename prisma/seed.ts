...
async function main() {
  ...
  const categories = [
    ...
    },
    {
      ...
      imageUrl: 'https://images.pexels.com/photos/1454188/pexels-photo-1454188.jpeg',
    },
    {
      name: 'Bangles',
      slug: 'bangles',
    ...
    },
    {
      ...
      imageUrl: 'https://images.pexels.com/photos/1454186/pexels-photo-1454186.jpeg',
    },
    {
      name: 'Pendants',
      slug: 'pendants',
  ...
  const products = [
    {
      ...
      description: 'A stunning 18K gold ring featuring a brilliant-cut diamond, symbolizing eternal love and commitment.',
      price: 45000,
      originalPrice: 52000,
      stock: 15,
      imageUrls: [
    ...
    },
    {
      ...
      description: 'Simple yet elegant 22K gold band, perfect for everyday wear or as a wedding ring.',
      price: 28000,
      originalPrice: 32000,
      stock: 25,
      imageUrls: [
    ...
    },
    {
      ...
      description: 'Majestic solitaire diamond ring in platinum setting, a timeless piece of luxury.',
      price: 95000,
    ...
    },
    {
      ...
      description: 'Delicate floral-design diamond studs in 18K white gold, perfect for any occasion.',
      price: 38000,
      originalPrice: 45000,
      stock: 20,
      imageUrls: [
    ...
    },
    {
      ...
      description: 'Elegant drop earrings in 22K gold with intricate craftsmanship.',
      price: 25000,
      stock: 30,
      imageUrls: [
        'https://images.pexels.com/photos/1454171/pexels-photo-1454171.jpeg',
    ...
    },
    {
      ...
      description: 'Beautiful dangle earrings featuring lustrous pearls set in gold.',
      price: 32000,
      originalPrice: 38000,
      stock: 18,
      imageUrls: [
    ...
    },
    {
      ...
      description: 'Exquisite 22K gold necklace with traditional Indian design, perfect for weddings and special occasions.',
      price: 125000,
    ...
    },
    {
      ...
      description: 'Contemporary diamond choker in white gold, perfect for modern brides.',
      price: 185000,
    ...
    },
    {
      ...
      description: 'Traditional South Indian temple jewelry necklace in pure gold.',
      price: 95000,
      stock: 10,
      imageUrls: [
        'https://images.pexels.com/photos/1454188/pexels-photo-1454188.jpeg',
    ...
    },
    {
      ...
      description: 'Set of 4 traditional 22K gold bangles with intricate patterns, essential for Indian brides.',
      price: 78000,
      originalPrice: 88000,
      stock: 12,
      imageUrls: [
    ...
    },
    {
      ...
      description: 'Sparkling diamond-cut gold bangles set, perfect for festive occasions.',
      price: 52000,
      stock: 20,
      imageUrls: [
        'https://images.pexels.com/photos/691046/pexels-photo-691046.jpeg',
    ...
    },
    {
      ...
      description: 'Classic tennis bracelet with brilliant diamonds in white gold setting.',
      price: 145000,
    ...
    },
    {
      ...
      description: 'Traditional Goddess Lakshmi pendant in 22K gold, symbol of prosperity.',
      price: 18000,
      originalPrice: 21000,
      stock: 30,
      imageUrls: [
    ...
    {
      name: 'Om Pendant',
      description: 'Sacred Om symbol pendant in pure gold for spiritual protection.',
      price: 12000,
      stock: 40,
      imageUrls: [
        'https://images.pexels.com/photos/691046/pexels-photo-691046.jpeg',
